...
class LargeGridWorld(GridWorldEnv):
    ...
    def __init__(self, windy=False):
        super(LargeGridWorld, self).__init__(
            n_width=10,
            n_height = 10,
            u_size = 40,
            default_reward = 0,
        ...
        self.types = [(4,2,1),(4,3,1),(4,4,1),(4,5,1),(4,6,1),(4,7,1),
                     ...
                     (8,7,1)]
        self.rewards = [(3,2,-1),(3,6,-1),(5,2,-1),(6,2,-1),(8,3,-1),
...
class CliffWalk(GridWorldEnv):
    ...
    def __init__(self, windy=False):
        ...
        self.action_space = spaces.Discrete(4) # left or right
        self.start = (0,0)
        self.ends = [(11,0)]
        # env.rewards=[]
        # env.types = [(5,1,1),(5,2,1)]
        self.rewards=[(11, 0, 50)]
        for i in range(10):
...
class SkullAndTreasure(GridWorldEnv):
    ...
    def __init__(self, windy=False):
        super(SkullAndTreasure, self).__init__(
            n_width=5,
            n_height = 2,
            u_size = 60,
            default_reward = -1,
